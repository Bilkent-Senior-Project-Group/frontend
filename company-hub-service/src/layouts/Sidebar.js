      ...
      <div className='sidebar-layout'>
        ...
        <div className={`sidebar ${isCollapsed ? 'collapsed' : ''}`}>
          <ul>
            ...
            <li><Link to="/discover"><FaCompass /><span className={isCollapsed ? 'collapsed-text' : ''}>Discover</span></Link></li>
            ...
            {isCompaniesExpanded && (
                <ul className="submenu">
                  <li>
                    <Link to="/company">Company 1</Link>
                  </li>
                  <li>
                    <Link to="/company">Company 2</Link>
                  </li>
                  <li>
                    <Link to="/company">Company 3</Link>
                  </li>
                </ul>
              )}
